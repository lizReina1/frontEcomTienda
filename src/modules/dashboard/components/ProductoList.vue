<template>
  <div id="ProductoList">
    ...
    <div class="col-sm-4">
      <button type="button" class="btn btn-info mb-3" @click="$emit('create')">Crear Producto</button>
    </div>
    <div class="row">
      <div class="col">
        <table class="table">
          ...
          <tbody>
            <tr v-for="producto in paginatedProductos" :key="producto.id">
              ...
              <td>
                <div class="row">
                  <div class="col-sm-2" @click="$emit('edit', producto)">
                  ...
                  <div class="col-sm-2" @click="$emit('view', producto)">
                  ...
                  <div class="col-sm-2" @click="$emit('delete', producto.id)">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <div class="card-body">
            <nav>
              <ul class="pagination flex-wrap d-flex justify-content-center">
                <li class="page-item">
                  <button class="page-link" @click="currentPage--" :disabled="currentPage === 1" data-abc="true"><i
                ...
                <li class="page-item">
                  <button class="page-link" @click="currentPage++" :disabled="currentPage === totalPages"
                    data-abc="true">Siguiente <i class="fa fa-angle-right"></i></button>
                </li>
              </ul>
            </nav>
          </div>
...
export default {
  ...
  methods: {
    filteredProductos() {
      if (!this.searchDate) return this.productos;
      const searchDate = new Date(this.searchDate);
      return this.productos.filter(producto => {
        const productoDate = new Date(producto.date);
        return productoDate.toDateString() === searchDate.toDateString();
      });
    },
  },
  computed: {
