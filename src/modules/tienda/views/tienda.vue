<template>
    ...
    <div class="card card1 p-3">
        ...
        <img src="https://i.imgur.com/R4afbIg.png" height="50" width="50" />
        <span>Clover</span>
        </div>
        <hr class="hline" />
        ...
        <span class="other mt-4">Other Information</span>
        <button class="btn mt-3">
            <i class="fa fa-book"></i><span>Knowlwdge</span>
        </button>
        <button class="btn mt-3">
    ...
    <div class="card card2 p-3">
        ...
        <div class="card cardchild mt-3 p-2 px-3 py-3">
            ...
            <div class="d-flex flex-column">
                <span class="type">Minimal</span
                ><span class="number">132</span>
            </div>
            <div class="d-flex flex-column">
                <img
                src="https://i.imgur.com/Slxu74c.png"
                class="logo1"
                height="40"
                width="40"
        ...
        <div class="card cardchild mt-3 p-2 px-3 py-3">
            <div class="d-flex p-2 mt-2 justify-content-between rounded">
            <div class="d-flex flex-column">
                <span class="type">Mild</span><span class="number">120</span>
            </div>
            <div class="d-flex flex-column">
                <img
                src="https://i.imgur.com/7SEdq7z.png"
                class="logo2"
                height="40"
                width="40"
        ...
        <div class="card cardchild mt-3 p-2 px-3 py-3">
            ...
            <div class="d-flex flex-column">
                <img
                src="https://i.imgur.com/xvUzRjK.png"
                class="logo3"
                height="40"
                width="40"
        ...
        <div class="card cardchild mt-3 p-2 px-3 py-3">
            <div class="d-flex p-2 mt-2 justify-content-between rounded">
            <div class="d-flex flex-column">
                <span class="type">Severe</span><span class="number">5</span>
            </div>
            <div class="d-flex flex-column">
                <img
                src=" https://i.imgur.com/iLU5F9A.png"
                class="logo4"
                height="40"
                width="40"
        ...
        <div class="col-md-6">
            ...
            >
                ...
                elit.Text elit more smtit.Kimto lee.
                </span>
            </div>
            <div
                class="d-flex justify-content-center align-items-center mt-3"
            >
                <button class="btn1">Next Appoinment</button>
            </div>
            <div
                class="icons d-flex flex-row justify-content-center gap-3 mt-4"
            >
